    ...
    <>
      <div className="border-stroke dark:border-strokedark flex flex-col border-b last-of-type:border-none">
        <button
          ...
          className="flex cursor-pointer items-center justify-between px-6 py-5 text-[20px] font-medium text-[#006bff] lg:px-9 lg:py-7.5 dark:text-white"
        >
          {quest}
        ...
        <p
          className={`border-stroke dark:border-strokedark border-t px-6 py-5 text-[18px] lg:px-9 lg:py-7.5 ${
