        ...
        <div className="max-w-c-1235 relative mx-auto px-4 md:px-8 xl:px-0">
          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center xl:gap-32.5">
            ...
            >
              ...
              <h2 className="relative mb-6 text-3xl font-bold text-black xl:text-[30px] dark:text-white">
                Frequently Asked
                <span className="before:bg-titlebg2 dark:before:bg-titlebgdark relative inline-block pl-[10px] before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full">
                  Questions
                </span>
              </h2>
