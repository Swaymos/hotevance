            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mt-5 mb-10">
                  At Hotevance Limited, we pride ourselves on being the leading
                  global provider of smart hospitality and property technology
                  solutions. From luxury hotels to modern condominiums, our
                  mission is to create seamless, secure, and intelligent
                  environments that elevate guest experiences while optimizing
                  operational efficiency.
                </p>

                <p className="mb-1.5 text-[12px] tracking-[5px] uppercase">
                  contact
                </p>
                <a
                  href="#"
                ...
                <p className="mt-[20px]">
                  &copy; {new Date().getFullYear()} Hotevance. All rights
                  reserved
                </p>
              </motion.div>

              <div className="flex w-full flex-col gap-8 md:flex md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                ...
                <motion.div
                  ...
                  transition={{ duration: 1, delay: 0.1 }}
                  viewport={{ once: true }}
                  className="animate_top m-w-[100%] md:m-w-[200px]"
                >
                  <h4 className="text-itemtitle2 mt-2 mb-2 font-medium text-black dark:text-white">
                    Location
                  </h4>

                  <p className="mt-5 mb-10 w-[100%] md:w-[70%]">
                    Suite 326 Rock of Ages mall,Utako Abuja beside AA Rano
                    filling station , FCT Abuja
                  </p>

                  <h4 className="text-itemtitle2 mb-2 font-medium text-black dark:text-white">
                    Phone Number
                  </h4>
